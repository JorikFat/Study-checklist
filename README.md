...
Для участия нужно сделать форк репозитория, взять любую задачу из сформированного проекта, написать в ней комментарий, выполнить ее и прислать pull-request
